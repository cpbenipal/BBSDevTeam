...
namespace BBS.Services.Contracts
{
    ...
    {
        List<SecondaryOfferShareData> InsertSecondaryOfferShareDataRange(List<SecondaryOfferShareData> secondaryOfferData);
        List<SecondaryOfferShareData> UpdateSecondaryOfferShareDataRange(List<SecondaryOfferShareData> secondaryOfferData);
