...
namespace BBS.Entities.Migrations
{
    ...
    [Migration("20220728085314_Add Primary Models")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BBS.Models.PrimaryOfferShareData", b =>
                {
                    ...
                    b.Property<int>("BidOnPrimaryOfferingId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("BidOnPrimaryOfferingId");
            ...
            modelBuilder.Entity("BBS.Models.PrimaryOfferShareData", b =>
                {
                    b.HasOne("BBS.Models.BidOnPrimaryOffering", "BidOnPrimaryOffering")
                        .WithMany()
                        .HasForeignKey("BidOnPrimaryOfferingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("BidOnPrimaryOffering");
