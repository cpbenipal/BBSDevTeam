...
namespace BBS.Entities.Migrations
{
    ...
    [Migration("20220818060828_cleanup")]
            ...
            modelBuilder.Entity("BBS.Models.Company", b =>
                {
                    ...
                    b.Property<string>("InvestmentManager")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("BBS.Models.Person", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddedById = 0,
                            AddedDate = new DateTime(2022, 8, 18, 11, 38, 27, 576, DateTimeKind.Local).AddTicks(3474),
                            AddressLine = "Dubai",
                            AnnualIncome = 10000000m,
                            City = "Dubai",
                            CountryId = 1,
                            DateOfBirth = new DateTime(2022, 8, 18, 6, 8, 27, 576, DateTimeKind.Utc).AddTicks(3476),
                            DateOfEmployement = new DateTime(2022, 8, 18, 6, 8, 27, 576, DateTimeKind.Utc).AddTicks(3482),
                            ...
                            LastName = "",
                            ModifiedById = 0,
                            ModifiedDate = new DateTime(2022, 8, 18, 11, 38, 27, 576, DateTimeKind.Local).AddTicks(3475),
                            NationalityId = 1,
            ...
            modelBuilder.Entity("BBS.Models.UserLogin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddedById = 0,
                            AddedDate = new DateTime(2022, 8, 18, 11, 38, 27, 576, DateTimeKind.Local).AddTicks(5008),
                            IsDeleted = false,
                            ModifiedById = 0,
                            ModifiedDate = new DateTime(2022, 8, 18, 11, 38, 27, 576, DateTimeKind.Local).AddTicks(5009),
                            Passcode = "MDAwMA==",
                            PasswordHash = new byte[] { 188, 17, 3, 204, 147, 145, 28, 110, 253, 20, 192, 22, 12, 42, 71, 21, 228, 236, 188, 166, 41, 138, 88, 115, 216, 157, 60, 87, 109, 209, 10, 6, 208, 65, 97, 58, 127, 39, 149, 157, 74, 120, 20, 102, 192, 121, 183, 57, 49, 127, 207, 195, 85, 56, 247, 46, 127, 184, 76, 186, 9, 193, 58, 21, 243, 86, 34, 87, 228, 98, 37, 165, 210, 78, 177, 121, 167, 10, 209, 73, 19, 168, 56, 253, 66, 147, 3, 180, 222, 167, 159, 184, 41, 15, 146, 64, 95, 172, 233, 4, 217, 45, 68, 195, 116, 175, 104, 111, 120, 75, 203, 149, 139, 2, 17, 93, 97, 203, 136, 109, 169, 86, 253, 156, 69, 151, 236, 49 },
                            PasswordSalt = new byte[] { 81, 117, 61, 204, 59, 87, 171, 201, 181, 5, 223, 54, 186, 19, 152, 93, 240, 141, 239, 222, 197, 158, 122, 170, 41, 217, 17, 79, 150, 159, 140, 20, 19, 205, 60, 25, 157, 143, 223, 22, 226, 135, 34, 164, 196, 199, 83, 207, 124, 90, 237, 16, 206, 211, 149, 194, 41, 99, 4, 103, 244, 253, 72, 47 },
                            PersonId = 1,
                            RefreshToken = "",
                            Username = ""
                        });
            ...
            modelBuilder.Entity("BBS.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddedById = 0,
                            AddedDate = new DateTime(2022, 8, 18, 11, 38, 27, 576, DateTimeKind.Local).AddTicks(5031),
                            IsDeleted = false,
                            ModifiedById = 0,
                            ModifiedDate = new DateTime(2022, 8, 18, 11, 38, 27, 576, DateTimeKind.Local).AddTicks(5031),
                            RoleId = 2,
                            UserLoginId = 1
                        });
                });
